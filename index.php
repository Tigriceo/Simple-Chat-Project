...
<div class="container">		
	<h1>Simple Chat Test Project</h1>
	<br>		
	...
	<?php } else { ?>
		<br>
		<br>
		<strong><a href="login.php"><h3>Зарегистрируйтесь для доступа к чату</h3></a></strong>
	<?php } ?>
	<br>
	<br>	
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="index.php">Обновить страничку</a>
	</div>	
</div>	
<?php ?>